...
const SearchBar = () => {
    ...
    return (
        <div className="">
            ...
            <IoSearch size={24} className="absolute left-3 lg:left-32 text-gray-700"/>
                <input
                    type="text"
                    placeholder='Search here'
                    onChange={(e) => setSearch(e.target.value)}
                    className=' bg-gray-200 placeholder-gray-400 rounded-lg px-7 lg:px-10 py-2 w-[95%] lg:w-96 md:w-96 outline-none text-black '
                />
            </div>
