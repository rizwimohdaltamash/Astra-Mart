            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        {/* text  */}
                        <h2 className=" text-2xl lg:text-3xl font-bold text-center">Order Details</h2>
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-gray-300 md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-gray-200 text-white bg-black md:max-w-xs">
                                                    {/* left  */}
                                                    <div className="p-8">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold text-orange-900">Order Id</div>
                                                                <div className="text-sm font-medium break-words lg:px-0 px-1">#{id}</div>
                                                            </div>

                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold text-orange-900">Date</div>
                                                                <div className="text-sm font-medium ">{date}</div>
                                                            </div>

                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold text-orange-900">Total Amount</div>
                                                                <div className="text-sm font-medium ">₹ {price * quantity}</div>
                                                            </div>

                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold text-orange-900">Order Status</div>
                                                                {status === 'pending' ?
                                                                    <div className="text-sm font-medium text-red-800 first-letter:uppercase">{status}</div>
                                                                    : <div className="text-sm font-medium text-green-300 first-letter:uppercase">{status}</div>
                                                                }
                                                            </div>
                                                        </div>
                                                    </div>
